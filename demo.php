<?php include_once('getLecture.php'); ?>
<!DOCTYPE html>
<html>
<head>
	<!-- META -->
...
<!-- 	<div class="lecture clearfix">
	...
	if (file_exists($filename='repository/archiver/'.$lecture['id'].'.zip')) echo '<span class="right" style="margin: 10px 0 10px 0; float:right;"><a title="скачать" class="download" href="download.php?id='.$lecture['id'].'"><i class="fa fa-download"></i></a></span>';

	echo '<h4><a href="demo/index.php?id='.$lecture['id'].'">'.$lecture['name'].'</a>';
	echo '</h4>';
