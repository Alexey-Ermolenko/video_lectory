<?php
	...
	if ($demoTypeArr[0] == "") {
		...
		echo $demoTypeArr[1]; //массив всех типов демонстрационных объектов на странице
	}
	*/
?>
<html>
...
<body>
	<header>
		...
		<nav id='secondNav'>
			...
			<a id="thisLink2" href='listLectureForCorrection.php'>Синхронизация лекции</a>
	...
	<section>
		...
		<div id='buttonbar2'>
			<p>Введите значение отклонения (с точкой, например 1.8, а не 1,8):</p>
...
function timeVideo() {
	//console.log("timeVideo = " + video.currentTime);
